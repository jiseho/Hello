...
public class CSBoardTO {
	...
	private String c_hit;
	private String c_wip;
	private String c_wdate;
	private int c_wgap;
	private String c_sgrpl;
	private int c_grp;
	private int c_grps;
	private int c_grpl;
	...
	public String getC_hit() {
		return c_hit;
	}
	public void setC_hit(String c_hit) {
		this.c_hit = c_hit;
	}
	public String getC_wip() {
		return c_wip;
	}
	public void setC_wip(String c_wip) {
		this.c_wip = c_wip;
	}
	...
	public int getC_wgap() {
		return c_wgap;
	}
	public void setC_wgap(int c_wgap) {
		this.c_wgap = c_wgap;
	}
	public String getC_sgrpl() {
		return c_sgrpl;
	}
	public void setC_sgrpl(String c_sgrpl) {
		this.c_sgrpl = c_sgrpl;
	}
	public int getC_grp() {
		return c_grp;
	}
	...
	public String toString() {
		return "CSBoardTO [c_no=" + c_no + ", c_branch=" + c_branch + ", c_subject=" + c_subject + ", c_name=" + c_name
				+ ", c_email=" + c_email + ", c_password=" + c_password + ", c_content=" + c_content + ", c_filename="
				+ c_filename + ", c_filesize=" + c_filesize + ", c_hit=" + c_hit + ", c_wip=" + c_wip + ", c_wdate="
				+ c_wdate + ", c_wgap=" + c_wgap + ", c_sgrpl=" + c_sgrpl + ", c_grp=" + c_grp + ", c_grps=" + c_grps
				+ ", c_grpl=" + c_grpl + "]";
	}
}
