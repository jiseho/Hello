									...
									<div class="contents_sub">
											...
											<table>
												...
												<tr>
													...
													<td colspan="3"><input type="text" name="subject"
														value="${n.n_subject }" class="board_view_input" /></td>
												</tr>
												<tr>
													<th>Password</th>
												...
												<tr>
													...
													<td colspan="3"><textarea name="content"
															class="board_editor_area">${n.n_content}</textarea></td>
												</tr>
											</table>
										</div>
										...
										<div class="btn_area">
											...
											<div class="align_right">
												...
												<input type="submit" value="Edit" id="mbtn" class="btn_write btn_txt01"
													style="cursor: pointer;" />
											</div>
										</div>
										<!--//게시판-->
